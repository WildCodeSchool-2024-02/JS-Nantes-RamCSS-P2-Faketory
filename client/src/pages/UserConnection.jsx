  ...
  useEffect(() => {
    fetch("http://localhost:3000/api/fakenewsnom")
        ...
        .then((data) => {
          ...
          const randomIndex2 = Math.floor(Math.random() * data.fakenewsnom.length);
          const randomIndex3 = Math.floor(Math.random() * data.fakenewsnom.length);
    ...
    fetch('http://localhost:3000/api/auth', {
      ...
      headers: {
        ...
        .then((data) => {
          ...
          console.warn('Authentication successful, token stored in localStorage:', data.token);
            navigate('/');
        })
        .catch((error) => {
          console.error('There was a problem with the fetch operation: ', error);
